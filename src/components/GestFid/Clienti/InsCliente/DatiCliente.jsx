...
export default class DatiClienteComponent extends Component {
    ...
    Salva = (values) => {
        ...
        ClientiService.insCliente({
            ...
            datacreazione: today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate(),
    ...
    render() {
        ...
        let {codfid,nominativo,indirizzo,comune,cap,prov,telefono,mail,attivo} = this.state;
        return ( 
            <section className="container">
                <div className="card">
                    <div className="card-body">
                        ...
                        <Formik 
                            initialValues={{codfid,nominativo,indirizzo,comune,cap,prov,telefono,mail,attivo}}
                            onSubmit={this.Salva}
